...
public:
	...
	void Draw(const std::string& _Text, float4 _Postion, int _TextColor, float _Size, float _Weight);
	void Draw(const std::wstring& _Text, float4 _Postion, int _TextColor, float _Size, float _Weight);
